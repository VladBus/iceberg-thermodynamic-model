...
| 10.15             | Operational end-to-end demonstration: 30-day real-forcing Lagrangian iceberg run (TEST_11: trajectory, mass −15.4 %, 7/7 checks; diagnostics 7/7, 7 figures) + full-model 1/7-day runs (exit 0; 3D ocean NaN from day 1 — pre-existing Stage 8 family); T-12 symlink prerequisite exercised; dependency audit; key finding: production executable does not run the iceberg module | — (pending)              | `docs/validation/stage10.15_operational_demonstration.md`                                                                                                             |
