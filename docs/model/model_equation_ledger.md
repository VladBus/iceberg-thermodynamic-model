...
*Этот документ является математической спецификацией текущей (Stage 9.4C.2) production модели. Все уравнения отражают фактический код, а не желаемую физику.*