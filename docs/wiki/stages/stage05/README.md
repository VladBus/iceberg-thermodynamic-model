...
| `Stage5.2_heat_enablement.md`            | Stage 5.2 — Controlled HEAT Enablement (historical report; status at time of writing: IN PROGRESS, completed by report end) |
| `Stage5.3_monthly_heat_validation.md`    | Stage 5.3 — 30-Day HEAT Integration and Thermodynamic Validation (COMPLETED)                                                |
| `Stage5.4_snowfall.md`                   | Stage 5.4 — ERA5 Snowfall Integration + Controlled Ice/Snow Tests                                                           |
| `Stage5.5_multimonth_integration.md`     | Stage 5.5 — Multi-Month ERA5 + HEAT Integration (COMPLETED)                                                                 |
