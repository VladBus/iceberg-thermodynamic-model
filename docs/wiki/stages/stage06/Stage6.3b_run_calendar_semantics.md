...
| `docs/wiki/stages/stage06/Stage6.3b_run_calendar_semantics.md` | Updated with applied fixes                                                                                                                                                 |
...
_Generated: Stage 6.3b audit — Fixes applied_
_No physics modified — metadata/semantics only_
