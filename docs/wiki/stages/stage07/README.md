...
| `Stage7.6C.1_Real_ice_initialization.md`                  | Stage 7.6C.1: Real Ice Initialization — OSI-SAF SIC + C3S SIT → 1_k.ice (historical shorthand for the category files `1_1.ice`–`1_5.ice`) |
