...
! Назначение: дополняет модуль grid_geometry, вычисляя локальные
!             маски для узлов U и V.
! Физика: Он определяет характер гидродинамических граничных условий:
!         условия прилипания (no-slip) или свободного скольжения (free-slip)
!         на твердых границах.
