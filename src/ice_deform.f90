...
!           EXY = 0.5*(∂U/∂y + ∂V/∂x)
!         Смещение EPR по upwind-схеме:
!           EPR_t+1 = EPR - dt1*(100/dx*(a1+a2) - CD2)
!         где a1,a2 — упреждающие разности (upwind).
...
contains
    ...
    subroutine deform(kl, dx, dt1)
        ...
        ! CD2 - тензор деформации (промежуточный).
